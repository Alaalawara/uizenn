  ...
  return (
    <header className="w-full sticky top-0 z-50 bg-[var(--bg)] flex py-2 border-b-1 border-[#e8e8e8e2] justify-between">
      ...
      <div className="flex items-center gap-3 text-sm">
        <a href="https://github.com/Alaalawara/uizenn" target="_blank" rel="noreferrer" className="rounded-lg border border-foreground/20 px-3 py-1 dark:bg-[var(--bg)] dark:text-[var(--fg)] hover:bg-secondary dark:hover:text-[var(--bg)]">
          GitHub
        </a>
        <a href="https://x.com/loops_infinity" target="_blank" rel="noreferrer" className="rounded-lg border border-foreground/20 px-3 py-1 dark:bg-[var(--bg)] dark:text-[var(--fg)] hover:bg-secondary dark:hover:text-[var(--bg)]">
          X
        </a>
        <ThemeToggle />
      </div>
...
function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggle}
      className="border rounded-lg p-0.5 border-foreground/20 cursor-pointer hover:bg-secondary"
      aria-label="dark-light mode"
    >
      <svg xmlns="http://www.w3.org/2000/svg"  width={25} height={25} className='dark:fill-[var(--fg)] dark:hover:fill-[var(--bg)] hover:bg-secondary rounded-lg' viewBox="0 0 64 64">
